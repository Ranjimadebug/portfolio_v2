...
export default function Contact() {
    const socials = [
        { name: "LinkedIn", link: "https://www.linkedin.com/in/ranjima-ghosh/", id: "01" },
        { name: "GitHub", link: "https://github.com/", id: "02" },
        { name: "Twitter / X", link: "https://x.com/RanjimaGhosh", id: "03" },
        { name: "GitLab", link: "https://gitlab.com/Ranjimadebug", id: "04" },
    ]
    ...
    return (
        <section
            ...
            id="contact"
            className="relative min-h-screen bg-(--background) py-24 md:py-30 lg:py-40 px-6 overflow-hidden flex flex-col justify-between"
        >
            <motion.div
                style={{
                    left: smoothX,
            ...
            <div className="max-w-7xl mx-auto w-full relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl leading-[0.95] font-black text-(--foreground) uppercase tracking-tighter">
                ...
                <div className="relative group">
                    ...
                    <motion.a
                        ...
                        className="relative border-b border-(--border) py-16 flex items-center justify-between overflow-hidden group/link"
                    >
                        <span className="text-xl md:text-[48px] font-bold text-(--foreground) group-hover/link:text-purple-400 transition-colors duration-700 z-10 group-hover/link:translate-x-4">
                        ...
                        <div className="absolute inset-0 bg-(--foreground)/2 opacity-0 group-hover/link:opacity-100 transition-opacity duration-700" />
                    </motion.a>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-(--border) mt-20 border border-(--border) overflow-hidden rounded-xl">
                    {socials.map((social, i) => (
                        <motion.a
                            ...
                            className="group relative bg-(--card) p-10 flex flex-col justify-between h-55 overflow-hidden transition-all duration-500"
                        >
                            ...
                            <div className="absolute inset-0 bg-linear-to-br from-(--foreground)/2 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                            {/* 3. Top Section: ID & Icon */}
                            <div className="flex justify-between items-start z-10">
                                <div className="flex flex-col gap-1">
                                    <span className="font-mono text-[9px] text-(--foreground)/40 uppercase tracking-[0.3em]">
                                        Connection
                                    </span>
                                ...
                                <div className="relative overflow-hidden w-6 h-6">
                                    <motion.span
                                        className="absolute inset-0 text-(--foreground)/30 group-hover:text-purple-500 transition-all duration-500 group-hover:-translate-y-full group-hover:translate-x-full"
                                    >
                                        ↗
                                    </motion.span>
                                    <motion.span
                            ...
                            <div className="z-10 flex flex-col gap-4">
                                <span className="text-xl md:text-2xl text-(--foreground)/70 group-hover:text-(--foreground) font-semibold tracking-tight transition-all duration-500 group-hover:translate-x-1">
                                    {social.name}
                                </span>
